...
/**
 Base class for all TiTodoSample views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TiTodoSample view hierarchy (such as wrapped iOS UIViews) was touched.
