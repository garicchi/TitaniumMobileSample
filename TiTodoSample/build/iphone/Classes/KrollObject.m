...
//@interface TiTodoSampleObject : NSObject
//@end

@interface TiTodoSampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiTodoSampleObject class]])
		{
			for (NSString *key in [[(TiTodoSampleObject*)o modules] allKeys])
			{
